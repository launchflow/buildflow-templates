...
class Walkthrough(Template):
    ...
    def template_flow_path(self):
        return os.path.join('walkthroughs', self.directory, '.buildflow', 'build', 'template.flow')
...
class StarterTemplate(Template):
    ...
    @property  
    def template_flow_path(self):
        return os.path.join('starter-templates', self.directory, '.buildflow', 'build', 'template.flow')
...
class Sample(Template):
    ...
    @property
    def template_flow_path(self):
        return os.path.join('samples', self.directory, '.buildflow', 'build', 'template.flow')
...
class BuildFlowTemplates:
    ...
    def __post_init__(self):
        ...
        self.starter_templates = [StarterTemplate(**template) for template in self.starter_templates]
...
def upload_template_to_fastapi(upload_url: str, github_base_url: str, template: Template):
...
github_base_url = 'https://github.com/launchflow/buildflow-templates/tree/main/starter-templates'
